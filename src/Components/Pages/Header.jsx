        ...
        <div>
            <div className='main flex flex-col   min-2xl:text-2xl '>
                ...
                <div className='z-30 top-20 relative gap-4 w-full flex flex-col rounded-lg shadow-lg  bg-white opacity-95 py-10'>
                        ...
                        <div className=' w-full absolute min-2xl:-top-14 px-35 max-sm:px-10'>
                            <div className=' w-full flex gap-6 mt-3 justify-center text-xl max-sm:text-sm min-2xl:text-3xl font-semibold p-5 min-2xl:py-8 px-10 rounded-lg shadow-lg  bg-white'>
