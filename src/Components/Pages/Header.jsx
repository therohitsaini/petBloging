    ...
    return (
        <div>
            <div className='w-full flex items-center h-full  '>
                ...
                <div className='px-30 max-sm:px-5 absolute max-sm:top-14 w-full mt-12 my-2'>
                    <div className=' relative gap-4 w-full flex flex-col rounded-lg shadow-lg mt-12 my-6 bg-white opacity-95 py-10 '>
                        <div className=''>
                            <div className='max-sm:w-full rounded-lg flex items-center justify-between gap-4 px-10 pt-5 min-2xl:pt-10 bg-white w-fit max-sm:flex'>
                                <button className='px-5 p-2 max-sm:p-3 border-1 rounded-sm bg-white items-center flex gap-2 text-lg min-2xl:text-xl max-sm:text-sm  font-semibold'>
                        ...
                        <div className='max-sm:flex max-sm:flex-col gap-3'>
                            <div className=' rounded-lg flex max-sm:flex-col min-2xl:flex min-2xl:flex-col min-2xl:items-center gap-1 px-10  bg-white w-full'>
                                <div className='flex flex-col w-full  min-2xl:flex min-2xl:gap-2'>
                                    <label htmlFor="" className='text-2xl max-sm:text-lg'>Boarding Near</label>
                                    <input type="address" className='px-2 border-1 text-xl py-1 min-2xl:px-6 min-2xl:py-2 w-full hover:bg-sky-100' placeholder='India' />
                                </div>
                                <div className='w-full flex flex-col min-2xl:flex min-2xl:gap-2'>
                                    <label htmlFor="" className='text-2xl max-sm:text-lg'>For These Days</label>
                                    <div className='w-full flex items-center gap-3 min-2xl:flex min-2xl:gap-5'>
                                        <input type="date" className='px-2 min-2xl:px-6 min-2xl:py-2 border-1 text-xl max-sm:text-sm py-1 hover:bg-sky-100 w-full ' placeholder="Drop Off" />
                                        <Icon width={30} className='text-gray-300' icon={"mynaui:arrow-right"} />
                                        <input type="date" className='px-2 min-2xl:px-6 min-2xl:py-2 border-1 text-xl max-sm:text-sm py-1 hover:bg-sky-100 w-full' placeholder='Pick up' />
                                    </div>
                                </div>
                            </div>

                            <div className='px-10 flex  flex-col gap-2 w-full'>
                                <p className='w-full text-2xl max-sm:text-lg'>How Many Pets ?</p>
