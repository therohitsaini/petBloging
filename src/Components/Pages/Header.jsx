...
function Header() {
    ...
    return (
        <div>
            <div className='main flex flex-col justify-center px-35 max-sm:px-2 min-2xl:px-80 min-2xl:py-20 min-2xl:text-2xl'>
                ...
                {}
                    ...
                    <div className=' rounded-lg flex max-sm:flex-col min-2xl:flex min-2xl:flex-col min-xl::items-center gap-4 px-10  bg-white w-full'>
                        ...
                        <div className='w-full flex flex-col min-2xl:flex min-2xl:gap-5 min-2xl:text-2xl'>
                            ...
                            <div className='w-full flex items-center gap-3 min-2xl:flex min-2xl:gap-5'>
                                <input type="date" className='px-2 min-2xl:px-6 min-2xl:py-4 border-1 text-xl py-1 hover:bg-sky-100 w-full ' placeholder="Drop Off" />
                                <Icon width={30} className='text-gray-300' icon={"mynaui:arrow-right"} />
                                <input type="date" className='px-2 min-2xl:px-6 min-2xl:py-4 border-1 text-xl py-1 hover:bg-sky-100 w-full' placeholder='Pick up' />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className=' w-full absolute -top-11 min-2xl:-top-14 px-35 max-sm:px-10'>
                        <div className=' w-full flex gap-6 mt-3 items-center text-xl max-sm:text-sm min-2xl:text-3xl font-semibold p-5 min-2xl:py-8 px-10 rounded-lg shadow-lg  bg-white'>
        ...
        <button className='px-5 p-3 border-1 rounded-sm bg-white'>Pet Boarding</button> */}
            ...
            <div  className={`price w-full ${toggle ? "" : ""} bg-slate-100 max-sm:flex max-sm:flex-col`}>
                {toggle ?
                    <div className='h-full px-35 max-sm:px-2 flex max-sm:flex-col py-10 gap-10 max-sm:gap-5'>
