        ...
        <div className='forgetPassword-main h-screen w-full flex'>
            ...
            <div className='h-screen w-[60%] py-5 px-16'>
                ...
                <form className='sign-in flex flex-col justify-center items-center gap-3 h-[650px] '>
                    <h1 className='heading text-4xl font-bold text-black w-96 mb-5'>Create New Password </h1>


                    <label className='flex flex-col  gap-1 w-96'>
                        <label for="text" className=' font-semibold text-[18px]' >New Password</label>
                        <input type='password' className='p-2 border-2 border-black rounded-md w-96' placeholder='Enter New Password' />
                    </label>

                    
                    <label className='flex flex-col  gap-1 w-96'>
                        <label for="text" className=' font-semibold text-[18px]' >Confirm Password</label>
                        <input type='password' className='p-2 border-2 border-black rounded-md w-96' placeholder='Enter Confirm Password' />
                    </label>
