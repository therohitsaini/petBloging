        ...
        <div className='form-main w-full h-screen flex'>
            ...
            <div className='form  w-[60%]   py-5 px-16 max-sm:w-full max-sm:px-4  max-sm:py-2'>
                    ...
                    <div className='sign-in  h-[97%]'>
                        <div className='w-full font-semibold flex justify-between '><span className='text-3xl'>Petpy.in</span>
                         {/* <span>If Dont have An Account? <Link to={"#"} className='text-green-500'  >Sign up</Link></span>  */}
                         </div>
                        <form className='sign-in flex flex-col justify-center items-center gap-2 h-[100%]  '>
                            ...
                            <label className='flex flex-col  gap-1 w-96 mt-10 max-sm:w-full'>
                                ...
                                <input type='text' className='p-2 border-2 border-black rounded-md  max-sm:w-full' placeholder='Enter username' />
                            </label>

                            <label className='flex flex-col  gap-1 w-96  max-sm:w-full'>
                                <label for="text" className=' font-semibold text-[18px]' >Password</label>
                                <input type='password' className='p-2 border-2 border-black rounded-md w-96  max-sm:w-full' placeholder='Enter username' />
                            </label>
